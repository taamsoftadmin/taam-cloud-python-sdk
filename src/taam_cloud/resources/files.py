...
from ..types import file_upload_params, file_retrieve_params
...
class FilesResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        Args:
          file_id: File ID returned from successful video generation
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"file_id": file_id}, file_retrieve_params.FileRetrieveParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"file_id": file_id}, file_retrieve_params.FileRetrieveParams),
            ),
            cast_to=FileRetrieveResponse,
        )
